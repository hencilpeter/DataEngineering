 ...
 * Program : Simple kafka producer to send catalog details to kafka(Asynchronous approach)
 * Description : This program reads the two files' catalog details and send to the kafka topic.
 * */
