 ...
 * Program : Dispatcher class with Synchronous commit
 * Purpose : This program is being used by the Sync consumer program.
 * */
...
public class consumer_dispatcher_commit_async implements Runnable {
    private final Consumer<String, String> threadConsumer;
    private final TopicPartition topicPartition;

    consumer_dispatcher_commit_async(Consumer<String, String> _threadConsumer, TopicPartition _topicPartition) {
