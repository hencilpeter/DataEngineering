 ...
 * Program : Consumer class with Asynchronous commit with multithreading capability.
...
public class consumer_commit_async_multithread {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for (int count = 0; count < countPartition; count++) {
            ...
            threadDispatchers[count] = new Thread(new consumer_dispatcher_commit_async(threadConsumer, partitionList.get(count)));
