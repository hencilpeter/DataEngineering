 ...
 * Program : Catalog Detail Deserialize class
 * */

package kafkacassandra;

public class CatalogDetailDeSerialize {
    public String PogId;
    public String Supc;
    public String Band;
    ...
    public CatalogDetailDeSerialize(String pogId, String supc, String band, String description, String size, String category, String subCatagory, String price,
    ...
    public CatalogDetailDeSerialize(){
        this.PogId = "";
        this.Supc = "";
        this.Band = "";
        this.Description = "";
